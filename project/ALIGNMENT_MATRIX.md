...
| AR-007a | JWT Authentication | | ✅ | [Security Model](HIGH_LEVEL_DESIGN.md#hld-security-model) | | `api/src/zotify_api/routes/jwt_auth.py` | ✅ | `api/docs/reference/source/JWT_AUTH.py.md` | |
