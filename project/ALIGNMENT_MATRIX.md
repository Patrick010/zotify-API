...
| AR-066 | Automated Governance Linter | | ✅ | [Doc Governance](HIGH_LEVEL_DESIGN.md#hld-documentation-governance) | [Ongoing Maintenance](LOW_LEVEL_DESIGN.md#lld-ongoing-maintenance) | `scripts/lint_governance_links.py`, `scripts/linter.py` | N/A | `AGENTS.md` | Refactored to support multiple `TRACE_INDEX.yml` formats for backward compatibility. Enforces documentation alignment and generates audit reports. |
| **Privacy & Security** | | | | | | | | | |
...
| AR-065 | Governance Audit Refactor | | ✅ | [Doc Governance](HIGH_LEVEL_DESIGN.md#hld-documentation-governance) | [Ongoing Maintenance](LOW_LEVEL_DESIGN.md#lld-ongoing-maintenance) | `scripts/repo_inventory_and_governance.py` | N/A | `project/proposals/GOVERNANCE_AUDIT_REFACTOR.md` | Bug fix applied to correctly handle single missing indexes in the audit report. The `site` directory is now ignored to prevent build artifacts from being included in the report. |
