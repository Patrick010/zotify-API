...
| AR-065 | Governance Audit Refactor | | 🟡 | [Doc Governance](HIGH_LEVEL_DESIGN.md#hld-documentation-governance) | [Ongoing Maintenance](LOW_LEVEL_DESIGN.md#lld-ongoing-maintenance) | `scripts/repo_inventory_and_governance.py` | N/A | `project/proposals/GOVERNANCE_AUDIT_REFACTOR.md` | New proposal to refactor the governance script into a full audit system. |
