...
| Role-Based Access Control (RBAC) | N | Y (Deferred) | Low | **Context:** Planned for multi-user environments, but current model is single-user. Now correctly tracked in `project/FUTURE_ENHANCEMENTS.md`. |
| **Spotify Integration** | | | | |
