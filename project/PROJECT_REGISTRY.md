...
**Note:** This registry is for high-level project management and architectural documents. For detailed technical documentation related to the API and its sub-modules, please see the [API Documentation Master Index](../api/docs/index.md).
