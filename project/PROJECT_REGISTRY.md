...
| **Logging Service** | [`api/src/zotify_api/core/log_service.py`](../api/src/zotify_api/core/log_service.py) | The core `LoggingService` implementation. |
| **Logging Handlers** | [`api/src/zotify_api/core/logging_handlers/`](../api/src/zotify_api/core/logging_handlers/) | Directory containing all concrete log handler implementations. |
| **Logging Configuration** | [`api/logging_config.yml`](../api/logging_config.yml) | The YAML configuration file for enabling and configuring log handlers. |
