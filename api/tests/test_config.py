...
def test_update_config(config_service_override):
    app.dependency_overrides[config_service.get_config_service] = config_service_override
...
def test_reset_config(config_service_override):
    app.dependency_overrides[config_service.get_config_service] = config_service_override
...
def test_update_persists_across_requests(config_service_override):
    app.dependency_overrides[config_service.get_config_service] = config_service_override
...
def test_reset_works_after_multiple_updates(config_service_override):
    app.dependency_overrides[config_service.get_config_service] = config_service_override
    client.patch("/api/config", json={"scan_on_startup": False})
    client.patch("/api/config", json={"library_path": "/another/path"})
...
def test_bad_update_fails_gracefully(config_service_override):
    app.dependency_overrides[config_service.get_config_service] = config_service_override
