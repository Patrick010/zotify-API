...
from zotify_api.routes import auth, metadata, cache, logging, system, user, playlist, tracks, downloads, spotify, sync, search, webhooks, notifications
...
modules = [auth, metadata, cache, logging, system, user, playlist, tracks, downloads, sync, config, network, search, webhooks, spotify, notifications]
for m in modules:
