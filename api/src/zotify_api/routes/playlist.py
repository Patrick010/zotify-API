...
from zotify_api.services.playlists_service import PlaylistsService, get_playlists_service, PlaylistsServiceError
...
def list_playlists(
    ...
    try:
        items, total = playlists_service.get_playlists(limit=limit, offset=offset, search=search)
